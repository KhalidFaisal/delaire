...
<footer class="mt-100 overflow-hidden footer-style-2">
            <div class="footer-top" style="background-color: var(--accent-color);">
                <div class="container">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    <h4 class="footer-heading d-flex align-items-center justify-content-between">
                                        ...
                                        <span class="d-md-none">
                                            <svg class="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg"
                                                width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--primary-color)"
                                    ...
                                    <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                        ...
                                        <li class="footer-menu-item"><a href="{{ route('web.blog') }}">Our Blogs</a></li>
                                        <li class="footer-menu-item"><a href="{{ route('contact') }}">Work with us</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    <h4 class="footer-heading d-flex align-items-center justify-content-between">
                                        ...
                                        <span class="d-md-none">
                                            <svg class="icon icon-dropdown" xmlns="http://www.w3.org/2000/svg"
                                                width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#de2e79"
                                                stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
                                                <polyline points="6 9 12 15 18 9"></polyline>
                                            </svg>
                                        </span>
                                    ...
                                    <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                        <li class="footer-menu-item"><a href="{{ route('search.product') }}">All Products</a></li>
                                        <li class="footer-menu-item"><a href="{{ route('search.product') }}">New Arrivals</a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    ...
                                    <ul class="footer-menu list-unstyled mb-0 d-md-block">
                                        ...
                                        <li class="footer-menu-item"><a href="{{ route('return.policy') }}">Return Policy</a></li>
                                                ...
                                                <li class="footer-social-item">
                                                    <a href="{{ $portfolio->linkedin_link ?? '#' }}" target="_blank">
                                                        <svg class="icon icon-linkedin" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <circle cx="4" cy="4" r="2" stroke="var(--primary-color)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                                        </svg>
                                                    </a>
                                                </li>
                                                <li class="footer-social-item">
            ...
            <div class="footer-bottom" style="background-color: var(--accent-color);">
    <div class="container">
