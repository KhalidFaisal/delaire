...
<footer class="mt-100 overflow-hidden footer-style-2">
                            ...
                            <div class="col-xl-4 col-lg-5 col-md-6 col-12 footer-widget">
                                <div class="footer-widget-inner">
                                    <h4 class="footer-logo">
                                        <a href="https://spreethemesprevious.github.io/"><img style="width:40%;" src="{{asset('main_view/assets/img/logo-accent.png')}}" alt="Pinkush"></a>
                                    </h4>
    ...
    <div class="container">
        <div class="footer-bottom-inner d-flex flex-column justify-content-center align-items-center text-center">
            <p style="color:#EB247C" class="copyright footer-text mb-0">
                ©<span class="current-year"></span> Pinkush Designed by
                <a style="color:#9c3464">Byte Engineers</a>
            </p>
        </div>
    </div>
</div>
