                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.roles.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="e.g. Stock Manager" required>
                            <small class="text-muted">Slug will be automatically generated (e.g. stock_manager).</small>
                        </div>
                                ...
                                <div class="border rounded p-3 bg-light h-100">
                                    <div class="d-flex justify-content-between align-items-center border-bottom pb-2 mb-2">
                                        ...
                                        <div class="form-check mb-0">
                                            ...
                                            <label class="form-check-label text-muted small" for="group_{{ Str::slug($groupName) }}">Select Group</label>
                                        </div>
                                    </div>
                                    <div class="permission-list" id="list_{{ Str::slug($groupName) }}">
                                        @foreach($permissions as $slug => $label)
                                        <div class="form-check my-2">
                                            <input class="form-check-input permission-checkbox" type="checkbox" name="permissions[]" value="{{ $slug }}" id="perm_{{ $slug }}" data-group="{{ Str::slug($groupName) }}">
